...
import { Form, Leaf, Camera, AlertTriangle, CheckCircle, Info, ChevronRight, Target } from 'lucide-react';
import MediaUploader from './MediaUploader';

const BiomassHarvestView = ({ plots = [], harvests = [], fetchWithAuth, theme, onSuccess }) => {
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-2">
                                        ...
                                        >
                                            ...
                                            {plots && plots.map(p => (
                                                <option key={p.id || p.plot_id} value={p.plot_id}>{p.plot_id} — {p.species}</option>
                                            ))}
                                        </select>
                                    </div>
                                    <div className="space-y-2">
